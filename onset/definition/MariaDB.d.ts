...
declare function mariadb_prepare(handleId: number, query: string, ...values: any[]): string;
declare function mariadb_query(handleId: number, query: string, callbackFunction: Function, ...callbackArgs: any[]): void;
declare function mariadb_async_query(handleId: number, query: string, callbackFunction: Function, ...callbackArgs: any[]): void;
declare function mariadb_await_query(handleId: number, query: string, useCache?: boolean): number;
